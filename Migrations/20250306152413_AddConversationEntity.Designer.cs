...
namespace HelloChat.Migrations
{
    ...
    [Migration("20250306152413_AddConversationEntity")]
            ...
            modelBuilder.Entity("HelloChat.Data.Message", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "From_User")
                        .WithMany()
                        .HasForeignKey("From_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "To_User")
                        .WithMany()
                        .HasForeignKey("To_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
